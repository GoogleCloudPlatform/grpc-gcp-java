...
public class GcpManagedChannelOptions {
  ...
  public static class GcpMetricsOptions {
    ...
    public static class Builder {
       ...
       * be exported using OpenTelemetry APIs. If both MetricRegistry and Meter are null, metrics are
       * disabled. If MetricRegistry is non-null, OpenCensus will be used.
       */

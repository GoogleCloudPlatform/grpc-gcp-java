...
public interface GqlQueryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.datastore.v1beta3.GqlQuery)
  ...
  java.util.Map<java.lang.String, com.google.datastore.v1beta3.GqlQueryParameter>
  getNamedBindings();
  /**
   * <pre>
   * For each non-reserved named binding site in the query string, there must be
   ...
   */
  java.util.List<com.google.datastore.v1beta3.GqlQueryParameter> 
   ...
   * <code>repeated .google.datastore.v1beta3.GqlQueryParameter positional_bindings = 4;</code>
   */
  com.google.datastore.v1beta3.GqlQueryParameter getPositionalBindings(int index);
  /**
   * <pre>
   * Numbered binding site &#64;1 references the first numbered parameter,
   * effectively using 1-based indexing, rather than the usual 0.
   ...
   * <code>repeated .google.datastore.v1beta3.GqlQueryParameter positional_bindings = 4;</code>
   */
  java.util.List<? extends com.google.datastore.v1beta3.GqlQueryParameterOrBuilder> 
   ...
   * <code>repeated .google.datastore.v1beta3.GqlQueryParameter positional_bindings = 4;</code>
   */
  com.google.datastore.v1beta3.GqlQueryParameterOrBuilder getPositionalBindingsOrBuilder(
      int index);
}
